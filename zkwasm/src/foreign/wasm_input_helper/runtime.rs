use zkwasm_foreign_sdk::{ForeignContext, HostEnv};
use zkwasm_types::{host_function::HostPlugin, types::ValueType};
...
pub fn register_wasm_input_foreign(
    ...
    env.register_function(
        ...
        zkwasm_types::host_function::Signature {
            ...
            return_type: Some(zkwasm_types::types::ValueType::I64),
        },
        wasm_input,
