...
impl<F: FieldExt> ETableAssign<F> for EventTableCommonConfig<F> {
    fn assign(
        &self,
        ctx: &mut Context<'_, F>,
        op_configs: &BTreeMap<OpcodeClassPlain, Rc<Box<dyn EventTableOpcodeConfig<F>>>>,
