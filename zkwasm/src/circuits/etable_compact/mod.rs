...
use crate::circuits::{
    ...
    etable_compact::op_configure::{
        ...
        op_br_if_eqz::BrIfEqzConfigBuilder, op_call::CallConfigBuilder,
        ...
        op_local_tee::LocalTeeConfigBuilder, op_rel::RelConfigBuilder,
        op_return::ReturnConfigBuilder, op_select::SelectConfigBuilder,
        op_store::StoreConfigBuilder, op_test::TestConfigBuilder, EventTableOpcodeConfigBuilder,
    },
    itable::{encode_inst_expr, Encode},
};
use crate::foreign::wasm_input_helper::etable_op_configure::{
...
use zkwasm_circuit_utils::{
    ...
    foreign::foreign_trait::ForeignTableConfig,
    nextn,
    tables::etable::{
        cell_allocator::EventTableCellAllocator,
        configure::{
            opcode::EventTableOpcodeConfig, EventTableCommonConfig,
            EventTableUnlimitColumnRotation, BITS_COLUMNS, ETABLE_STEP_SIZE, MAX_OP_LVL1,
            MAX_OP_LVL2, MTABLE_LOOKUPS_SIZE, U4_COLUMNS, U8_COLUMNS,
        },
        constraint_builder::ConstraintBuilder,
        foreign::EventTableForeignCallConfigBuilder,
    },
};
use zkwasm_foreign_sha256::etable_op_configure::{
