...
use zkwasm_circuit_utils::{
    ...
    tables::etable::configure::{opcode::MLookupItem, step_status::StepStatus},
};
use zkwasm_circuit_utils::{expr::bn_to_field, tables::mtable::encode::MemoryTableLookupEncode};
use zkwasm_types::itable::{OPCODE_ARG0_SHIFT, OPCODE_ARG1_SHIFT, OPCODE_CLASS_SHIFT};
use zkwasm_types::step::StepInfo;
use zkwasm_types::types::ValueType;
