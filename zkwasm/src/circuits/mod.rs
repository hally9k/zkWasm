...
use crate::{
    ...
    foreign::wasm_input_helper::circuits::{
        assign::WasmInputHelperTableChip, WasmInputHelperTableConfig, WASM_INPUT_FOREIGN_TABLE_KEY,
    },
};
...
use zkwasm_circuit_utils::{
    foreign::foreign_trait::ForeignTableConfig, layouter::context::Context,
};
use zkwasm_foreign_sha256::{
