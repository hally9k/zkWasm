...
use zkwasm_circuit_utils::{
    cells::offset_len_bits_table_lookup_cell::offset_len_bits_encode,
    columns::bit_range_column::BitRangeTable, constant_from, expr::bn_to_field,
};
use zkwasm_config::POW_TABLE_LIMIT;
use zkwasm_types::itable::BitOp;
