...
use zkwasm_types::mtable::{AccessType, LocationType};
...
pub struct MemoryTableLookupEncode;

impl MemoryTableLookupEncode {
    pub fn encode_for_lookup<T: FromBn + Add<T, Output = T> + Mul<T, Output = T>>(
        eid: T,
        emid: T,
        mmid: T,
        offset: T,
...
impl MemoryTableLookupEncode {
    pub fn encode_stack_read<T: FromBn + Add<T, Output = T> + Mul<T, Output = T>>(
        eid: T,
        emid: T,
        sp: T,
        vtype: T,
    ...
    pub fn encode_stack_write<T: FromBn + Add<T, Output = T> + Mul<T, Output = T>>(
        eid: T,
        emid: T,
        sp: T,
        vtype: T,
    ...
    pub fn encode_memory_load<T: FromBn + Add<T, Output = T> + Mul<T, Output = T>>(
        eid: T,
        emid: T,
        mmid: T,
        address: T,
    ...
    pub fn encode_memory_store<T: FromBn + Add<T, Output = T> + Mul<T, Output = T>>(
        eid: T,
        emid: T,
        mmid: T,
        address: T,
    ...
    pub fn encode_global_get<T: FromBn + Add<T, Output = T> + Mul<T, Output = T>>(
        eid: T,
        emid: T,
        mmid: T,
        address: T,
    ...
    pub fn encode_global_set<T: FromBn + Add<T, Output = T> + Mul<T, Output = T>>(
        eid: T,
        emid: T,
        mmid: T,
        address: T,
