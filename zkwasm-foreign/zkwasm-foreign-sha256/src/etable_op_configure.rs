...
use zkwasm_circuit_utils::{
    cells::{bit_cell::BitCell, mtable_lookup_cell::MTableLookupCell, u64_on_u8_cell::U64OnU8Cell},
    constant_from, constant_from_bn,
    expr::bn_to_field,
    foreign::foreign_trait::ForeignCallInfo,
    layouter::context::Context,
    tables::{
        etable::{
            cell_allocator::EventTableCellAllocator,
            configure::{
                opcode::{EventTableOpcodeConfig, MLookupItem},
                step_status::StepStatus,
                EventTableCommonConfig,
            },
