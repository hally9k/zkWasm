    ...
    fn assign(
        ...
        let (value, value_type, result, result_type) = match entry.step_info {
            ...
            StepInfo::I64ExtendI32 {
                ...
                self.flag_u8_rem.assign(ctx, flag_u8_rem as u64)?;
                self.flag_u8_rem_diff.assign(ctx, flag_u8_rem_diff as u64)?;
        ...
        self.value_type.assign(ctx, value_type as u64)?;
        self.res_type.assign(ctx, result_type as u64)?;
